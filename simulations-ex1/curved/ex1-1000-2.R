...
gamma <- 1-2/sqrt(n)    # Pr(D_i = 1); rho in the paper
#
...
for(boot_iter in 1:N){
  ...
  #
  smc_run <- SMC_curved(mdata_short,trans_pars,keep,scalepar,loglike_short,PKernel_temp,cl)
  #
...
save(boot_results,file="results/n1000/2.RData")
#
stopCluster(cl)
#
#END
